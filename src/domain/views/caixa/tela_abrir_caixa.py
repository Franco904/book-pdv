...
class TelaAbrirCaixa(Tela):
    ...
    def init_components(self, caixas_names=None):
        ...
        sg.theme("Reddit")
        layout = [
            [sg.Combo(caixas_names, readonly=True, size=(40, 1), key="caixa_field")],

            [sg.Text("Data", size=(24, 0), font=("", 10)), sg.Text(data, size=(24, 0), font=("", 10))],
            [sg.Text("Valor", size=(24, 0), font=("", 10)), sg.Text(valor, size=(24, 0), font=("", 10))],
